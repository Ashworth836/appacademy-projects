...
You can also use the tools at your disposal to do a little exploration. Try making use of the built in dir function. Use it to print the attributes of the form object inside the validation if statement.
