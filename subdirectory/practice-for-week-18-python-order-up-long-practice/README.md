...
In the `.env` file, put this content to set the current Flask environment to
...
[4]: https://wtforms.readthedocs.io/en/2.3.x/fields/#wtforms.fields.SelectField# practice-for-week-18-python-order-up-long-practice
